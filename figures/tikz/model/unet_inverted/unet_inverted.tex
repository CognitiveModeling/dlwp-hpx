...
\begin{document}
	...
	\pic [right=1.8cm of input] {annotated cuboid={width=2.6, height=4, depth=4, units=, label=e1-1, lwidth=256, lheight=64, ccolor=convblockcolor}};
	...
	\pic [right=1.1cm of e3-1] {annotated cuboid={width=1.3, height=1, depth=1, units=, label=e3-2, lwidth=64, lheight=16, ccolor=convblockcolor}};
	\pic [right=1.4cm of e3-2] {annotated cuboid={width=1.9, height=1, depth=1, units=, label=e3-3, lwidth=128, lheight=16, ccolor=convcolor}};
	...
	% Maps
	\pic [right=2.5cm of e2-2] {annotated cuboid={width=1.9, height=2, depth=2, units=, label=d2-1, lwidth=128, lheight=32}};
	...
	\pic [right=1.8 of d2-2] {annotated cuboid={width=2.6, height=2, depth=2, units=, label=d2-3, lwidth=256, lheight=32, ccolor=convblockcolor}};
	...
	\pic [right=7cm of e1-1] {annotated cuboid={width=2.6, height=4, depth=4, units=, label=d1-1, lwidth=256, lheight=64}};
	\pic [right=1.3cm of d1-1] {annotated cuboid={width=2.6, height=4, depth=4, units=, label=d1-2, lwidth=256, lheight=, ccolor=upscalecolor}};
	\pic [right=1.8 of d1-2] {annotated cuboid={width=2.6, height=4, depth=4, units=, label=d1-3, lwidth=256, lheight=64, ccolor=convblockcolor}};
	\pic [right=1.0 of d1-3] {annotated cuboid={width=0.7, height=4, depth=4, units=, label=d1-4, lwidth=14, lheight=64, ccolor=convcolor}};
