...
\begin{document}
	...
	\pic [right=4.0cm of input] {annotated cuboid={width=0.7, height=4, depth=4, units=, label=output, lwidth=$c$, lheight=$2n$, ccolor=upscalecolor}};
	
	% Arrows
	\draw[forward] (input) -- (output) node[projection] {\shortstack[l]{$2\times2$ tansp conv,\\stride 2}};
