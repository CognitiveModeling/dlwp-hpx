...
\begin{document}
	...
	\pic [right=2cm of input] {annotated cuboid={width=0.7, height=4, depth=4, units=, label=inter, lwidth=$c$, lheight=$2n$, ccolor=upscalecolor}};
	\pic [right=2.5cm of inter] {annotated cuboid={width=0.7, height=4, depth=4, units=, label=conv, lwidth=$c$, lheight=$2n$, ccolor=upscalecolor}};
	
	% Arrows
	\draw[forward] (input) -- (inter) node[projection] {\shortstack[l]{inter-\\polation}};
	\draw[forward] (inter) -- (conv) node[projection] {\shortstack[l]{$3\times3$ conv,\\leaky ReLU}};
