...
\begin{document}
	...
	% Dilation remark
	\node[right=3cm of e3-2, forwardcolor] {Dilation $= 4$};
	
	% Second layer up
	
	% Maps
	\pic [right=2.8cm of e2-2] {annotated cuboid={width=1.9, height=2, depth=2, units=, label=d2-1, lwidth=128, lheight=32, ccolor=conv3color}};
	\pic [right=0.6cm of d2-1] {annotated cuboid={width=1.3, height=2, depth=2, units=, label=d2-2, lwidth=64, lheight=, ccolor=downscalecolor}};
	...
	\pic [right=1.2 of d2-4] {annotated cuboid={width=1.3, height=2, depth=2, units=, label=d2-5, lwidth=64, lheight=32, ccolor=conv1color}};
	...
	% Dilation remark
	\node[right=1cm of d2-5, forwardcolor] {Dilation $= 2$};
	
	%
	% First layer up
	
	\pic [right=10cm of e1-1] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=d1-1, lwidth=64, lheight=64, ccolor=conv3color}};
	...
	\pic [right=0.6cm of d1-2] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=d1-3, lwidth=64, lheight=, ccolor=upscalecolor}};
	\pic [right=1.4 of d1-3] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=d1-4, lwidth=64, lheight=64, ccolor=convblockcolor}};
	\pic [right=1.1 of d1-4] {annotated cuboid={width=0.7, height=4, depth=4, units=, label=d1-5, lwidth=16, lheight=64, ccolor=conv1color}};
