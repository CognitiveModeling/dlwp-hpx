...
\begin{document}
	...
	\pic [right=1.2cm of input] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=e1-1, lwidth=64, lheight=64, ccolor=convblockcolor}};
	...
	% Maps
	\pic [below=2.3cm of e1-1] {annotated cuboid={width=1.3, height=2, depth=2, units=, label=e2-1, lwidth=64, lheight=32, ccolor=downscalecolor}};
	...
	\pic [right=1.8cm of e3-1] {annotated cuboid={width=2.6, height=1, depth=1, units=, label=e3-2, lwidth=256, lheight=16, ccolor=convblockcolor}};
	\pic [right=1.45cm of e3-2] {annotated cuboid={width=1.9, height=1, depth=1, units=, label=e3-3, lwidth=128, lheight=16, ccolor=convcolor}};
	...
	% Maps
	\pic [right=4cm of e2-2] {annotated cuboid={width=1.9, height=2, depth=2, units=, label=d2-1, lwidth=128, lheight=32}};
	\pic [right=0.9cm of d2-1] {annotated cuboid={width=1.9, height=2, depth=2, units=, label=d2-2, lwidth=128, lheight=, ccolor=upscalecolor}};
	\pic [right=1.4 of d2-2] {annotated cuboid={width=1.9, height=2, depth=2, units=, label=d2-3, lwidth=128, lheight=32, ccolor=convblockcolor}};
		
	% Arrows
	\draw[forward] (e2-2) -- (d2-1);
	\draw[upscale] (e3-3.north) --++ (0, 18pt) -- ([yshift=18pt]e3-3.north -| d2-2.south) -- (d2-2.south);
	\draw[convblock] (d2-2) -- (d2-3);
	
	%
	% First layer up
	
	\pic [right=10cm of e1-1] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=d1-1, lwidth=64, lheight=64}};
	\pic [right=0.6cm of d1-1] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=d1-2, lwidth=64, lheight=, ccolor=upscalecolor}};
	\pic [right=1.4 of d1-2] {annotated cuboid={width=1.3, height=4, depth=4, units=, label=d1-3, lwidth=64, lheight=64, ccolor=convblockcolor}};
	\pic [right=1.2 of d1-3] {annotated cuboid={width=0.7, height=4, depth=4, units=, label=d1-4, lwidth=14, lheight=64, ccolor=convcolor}};

	% Arrows
	\draw[forward] (e1-1) -- (d1-1);
	\draw[upscale] (d2-3.north) --++ (0, 28pt) -- ([yshift=28pt]d2-3.north -| d1-2.south) -- (d1-2.south);
	...
	%
	% Legend
	\draw[conv] ([yshift=2.5cm]input.north) --++ (1, 0) node[right] (convlabel) {$1\times1$ convolution};
	\draw[convblock] ([yshift=2.5cm, xshift=5cm]input.north) --++ (1, 0) node[right] (convblocklabel) {conv block};
	\draw[downscale] ([yshift=2.5cm, xshift=9cm]input.north) --++ (1, 0) node[right] (downscalelabel) {$2\times2$ Max-Pool};
